...
class RoleOperations(object):
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :param request:
        :type request: ~Runway.Py.models.CreateRoleRequest
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/json" or "application/*+json". Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~Runway.Py.models.QueryResponseOfIRoleView
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type role_id: str
        :param request:
        :type request: ~Runway.Py.models.UpdateRoleRequest
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/json" or "application/*+json". Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def load(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~Runway.Py.models.RunwayRole
        :raises: ~azure.core.exceptions.HttpResponseError
        """
