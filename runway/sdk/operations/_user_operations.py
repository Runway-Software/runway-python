...
def build_delete_by_set_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users")
...
def build_delete_by_id_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/{userId}")
...
def build_get_tags_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/tags")
...
def build_query_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/query")
...
def build_count_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/count")
...
def build_count_query_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/count/query")
...
def build_get_query_schema_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/query/schema")
...
def build_save_query_to_set_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/api/v2/users/query/set/{setId}")
    path_format_arguments = {
...
class UserOperations(object):
    ...
    delete_by_set.metadata = {'url': "/api/v2/users"}  # type: ignore
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :param request:
        :type request: ~Runway.Python.models.CreateUserRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~Runway.Python.models.QueryResponseOfIUserQueryView
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    delete_by_id.metadata = {'url': "/api/v2/users/{userId}"}  # type: ignore
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type user_id: str
        :param request:
        :type request: ~Runway.Python.models.UpdateUserRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: IO, or the result of cls(response)
        :rtype: IO
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    get_tags.metadata = {'url': "/api/v2/users/tags"}  # type: ignore
    ...
    count_query.metadata = {'url': "/api/v2/users/count/query"}  # type: ignore
    ...
    get_query_schema.metadata = {'url': "/api/v2/users/query/schema"}  # type: ignore
    ...
    save_query_to_set.metadata = {'url': "/api/v2/users/query/set/{setId}"}  # type: ignore
