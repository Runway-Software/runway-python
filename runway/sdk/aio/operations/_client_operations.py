...
from ...operations._client_operations import build_socket_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ClientOperations:
    """ClientOperations async operations.
    ...
    async def socket(
        ...
        **kwargs: Any
        ...
        request = build_socket_request(
            template_url=self.socket.metadata['url'],
        )
    ...
    socket.metadata = {'url': "/api/v2/client/socket"}  # type: ignore
