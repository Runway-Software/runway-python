...
class ConnectionOperations:
    ...
    delete_by_set.metadata = {'url': "/api/v2/connections"}  # type: ignore


    @distributed_trace_async
    async def create(
        self,
        request: "_models.CreateConnectionRequest",
        **kwargs: Any
    ) -> "_models.IdResponse":
        """create.

        :param request:
        :type request: ~Runway.Python.models.CreateConnectionRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def list(
        self,
        **kwargs: Any
    ) -> "_models.QueryResponseOfIConnectionQueryView":
        """list.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: QueryResponseOfIConnectionQueryView, or the result of cls(response)
        :rtype: ~Runway.Python.models.QueryResponseOfIConnectionQueryView
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    delete_by_id.metadata = {'url': "/api/v2/connections/{connectionId}"}  # type: ignore
    ...
    async def update(
        self,
        connection_id: str,
        request: "_models.UpdateConnectionRequest",
        **kwargs: Any
    ) -> IO:
        """update.
        ...
        :type connection_id: str
        :param request:
        :type request: ~Runway.Python.models.UpdateConnectionRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: IO, or the result of cls(response)
        :rtype: IO
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def load(
        ...
        **kwargs: Any
        ...
        :rtype: ~Runway.Python.models.RunwayConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    get_tags.metadata = {'url': "/api/v2/connections/tags"}  # type: ignore
    ...
    count_query.metadata = {'url': "/api/v2/connections/count/query"}  # type: ignore
    ...
    get_query_schema.metadata = {'url': "/api/v2/connections/query/schema"}  # type: ignore
    ...
    save_query_to_set.metadata = {'url': "/api/v2/connections/query/set/{setId}"}  # type: ignore
