...
from ...operations._repository_operations import build_count_request, build_countquery_request, build_createaction_request, build_downloadaction_request, build_getactioncontentinfo_request, build_getqueryschema_request, build_gettags_request, build_list_request, build_load_request, build_loadbyname_request, build_query_request, build_savequerytoset_request
T = TypeVar('T')
...
class repositoryOperations:
    ...
    @distributed_trace_async
    async def getactioncontentinfo(
        self,
        actionid: str,
        **kwargs: Any
    ) -> "_models.contentInfo":
