...
from ...operations._runner_operations import build_begindissolverunners_request, build_completedissolverunner_request, build_count_request, build_countquery_request, build_deletebyid_request, build_deletebyset_request, build_getqueryschema_request, build_gettags_request, build_list_request, build_load_request, build_query_request, build_querybygroupid_request, build_querybyip_request, build_savequerytoset_request
T = TypeVar('T')
...
class runnerOperations:
    ...
    @distributed_trace_async
    async def begindissolverunners(
        self,
    ...
    @distributed_trace_async
    async def completedissolverunner(
        self,
        **kwargs: Any
    ) -> IO:
